...
public partial class LmsCustomerAndProspect
{
    ...
    public string ProspectCustomrFlag { get; set; } = null!;
    ...
    public string? ImportExportFlag { get; set; }
    ...
    public string? LeadEndReason { get; set; }
    ...
    public bool? ClosedWonFlag { get; set; }

    public bool? ClosedNotWonFlag { get; set; }
