...
public partial class Pac
{
    ...
    public int? IdAlertaNaoConformidade { get; set; }
    ...
    public int? IdAlertaAccaoCorrectiva { get; set; }
    ...
    public int? IdAlertaAvaliacao { get; set; }
    ...
    public int? IdAlertaEficacia { get; set; }
